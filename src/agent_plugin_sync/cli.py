...
from agent_plugin_sync import bootstrap, emit, io, model, validate
...
def _emit(plugin_root: pathlib.Path) -> list[base.EmittedFile]:
    ...
    return emit.emit_all(plugin_model)
